...
export class RestService {
  ...
  createStack(server: string, suffixe: string, typeDb: string, HTTP_PROXY: string, HTTPS_PROXY: string, NO_PROXY: string, http_proxy: string, https_proxy: string, no_proxy: string, mdp: string): Observable<any> {
  ...
  updateStack(id: string, server: string, nameStack: string, imageBdd: string, nameContainerBdd: string, imageContainer: string, nameContainer: string,HTTP_PROXY: string, HTTPS_PROXY: string, NO_PROXY: string, http_proxy: string, https_proxy: string, no_proxy: string, MDP_BDD: string): Observable<any> {
